...
{
    public partial class PC10 : Form
    {
        BLL.fmd050 _bllFMD010 = new BLL.fmd050();
        Model.fmd050 _modelFMD010 = new Model.fmd050();
        ...
        private void SetSpdFormat()
        {
            try
            {
                ...
                fspd.ActiveSheet.Columns[SpdColNo.CLBH, SpdColNo.ZDKC].CellType = textCellType;
                fspd.ActiveSheet.Columns[SpdColNo.CLBH, SpdColNo.ZDKC].Width = 134F;
               ...
               // fspd.ActiveSheet.Columns.Get(0, SpreadColCount - 1).Resizable = false;           
                ...
                #region 锁定列
                fspd.ActiveSheet.Columns.Get(SpdColNo.CLBH, SpdColNo.ZDKC).Locked = true;
        ...
        private void Spd_Form_Load() //绑定Spread的数据
        {
            try
            {
                ...
                dtspd =_bllFMD010.GetDaTaForPC08Spread("",txtYCLBH.Text.Trim(),StaticFun.getValue(cboZT) );
        ...
        Model.fmd050 fillModel(int i)
        {
            Model.fmd050 modelfmd010 = new Model.fmd050();
            #region model 赋值
        ...
        List<Model.fmd050> GetModel()
        {
            List<Model.fmd050> listmodelFKD100 = new List<Model.fmd050>();
            Model.fmd050 modelfmd010 = new Model.fmd050();
            for (int i = 0; i < fspd.ActiveSheet.Rows.Count; i++)//循环spread model赋值
            {
                if (fspd.ActiveSheet.Cells[i, SpdColNo.CHECK].Text == "True")
                {
                    modelfmd010 = new Model.fmd050();
        ...
        List<Model.fmd050> listmodelFMD100 = new List<Model.fmd050>();
              ...
              //  Button btn = (Button)(sender);
                ...
                if (getcheckHasTrue()>0)// 有选中的数据
                {
                    if (ComForm.DspMsg(strQ, "") == "0")
                    {
                        ...
                        foreach (Model.fmd050 modelFKD100 in listmodelFMD100)
                        {
                            ...
                            {
                                sqlList.Add(_bllFMD010.Del(modelFKD100.CLBH));
                            }
